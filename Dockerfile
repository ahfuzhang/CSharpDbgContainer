...
RUN curl -fsSL https://dot.net/v1/dotnet-install.sh -o dotnet-install.sh && \
    ...
    echo "install dotnet-coverage:============================" && \
    /usr/share/dotnet/dotnet tool install dotnet-coverage --tool-path /usr/bin/dotnetsdk/ && \
     /usr/share/dotnet/dotnet tool install dotnet-reportgenerator-globaltool --tool-path /usr/bin/dotnetsdk/ && \
    echo "install vector:============================" && \
